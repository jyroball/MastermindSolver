 ...
 * File:   main.cpp
 * Author: Jyro Jimenez
 * Purpose:  Mastermind Version 1: Basic
 */
...
int main(int argc, char** argv) {
    ...
    cout << "The computer will generate a code with the numbers 1-8, it is your job to " << endl
         << "figure out what the string of code is by guessing each individual number." << endl;
    ...
    cout << "What code length do you want? (4/6/8): ";
    cin >> length;
    //Validate
